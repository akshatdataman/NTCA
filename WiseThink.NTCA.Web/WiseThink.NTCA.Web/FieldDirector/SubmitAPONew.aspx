<%@ Page Title="" Language="C#" MasterPageFile="~/FieldDirector/FieldDirector.Master" AutoEventWireup="true" CodeBehind="SubmitAPONew.aspx.cs" Inherits="WiseThink.NTCA.Web.FieldDirector.SubmitAPONew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function closeDetailpopup(e) {
            ...
            //$("#detailModal").removeClass("in");
            //$("#detailModal").css("display", "none");
            //$.session.set("detailModal", "");

            //window.parent.location.reload();
            document.getElementById("APOLink").click();
        }
    </script>
</asp:Content>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal" onclick="closeDetailpopup(this)">
                                Close</button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                ...
                                                <cc:CustomLinkButton ID="clbDocumentFile" runat="server" Text=""
                                                    OnClientClick="SetSessionValues(this,'gvNRCore','1','1','Download');RemoveBlockUi() "></cc:CustomLinkButton>
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                ...
                                                <cc:CustomImageButton ID="imgbtnDeleteNrCore" runat="server" OnClientClick="setNonRecuring_Core(); DeleteAPOSubItems(this,'gvNRCore','1','1','SubmitAPO'); return false;"
                                                            ...
                                                            <cc:CustomGridView ID="ChildRecordsRecurring" runat="server" Width="100%" AutoGenerateColumns="false" DataKeyNames="ActivityItemId" ShowFooter="false"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblActivityItemId" runat="server" Style="display: block" Text='<%#Eval("ActivityItemId") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblId" runat="server" Style="display: block" Text='<%#Eval("ID") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>

                                                                    <asp:TemplateField Visible="false">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblSubItemTypeId" runat="server" Style="display: block" Text='<%#Eval("SubItemId") %>'></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="ParaNo TCP" ItemStyle-Width="100px">
                                                                        <ItemTemplate>
                                                                            <%#Eval("ParaNoTCP") %>
                                                                        </ItemTemplate>
                                                                        <EditItemTemplate>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Number of Items" ItemStyle-Width="100px" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Center">
                                                                        ...
                                                                        <EditItemTemplate>
                                                                            <asp:TextBox ID="txtNumberOfItemsChild" Text='<%#Eval("NumberOfItems") %>' runat="server" CssClass="less_size" onFocusout="return validate(this.value,this);"></asp:TextBox>
                                                                        </EditItemTemplate>
                                                                    </asp:TemplateField>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Unit Price" ItemStyle-Width="100px" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Right">
                                                                        ...
                                                                        <EditItemTemplate>
                                                                            <asp:TextBox ID="txtUnitPriceChild" Text='<%#Eval("UnitPrice") %>' runat="server" CssClass="less_size" onFocusout="return validate(this.value,this)"></asp:TextBox>
                                                                        </EditItemTemplate>
                                                                    </asp:TemplateField>

                                                                    <asp:TemplateField HeaderText="Total" ItemStyle-Width="100px" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:label ID="txtTotalChild" runat="server" Text='<%#Eval("Total") %>' CssClass="less_size"></asp:label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField ControlStyle-Width="200px">
                                            <ItemTemplate>
                                                <cc:CustomLabel ID="lblGpsNote" runat="server" CssClass="less_size text-left" Text="Click icon to add GPS"></cc:CustomLabel>
                                                <cc:CustomImageButton ID="updateSomething" runat="server" CssClass="text-center"
                                                    Style="width: 50px; height: 25px;" ImageUrl="../Images/gps1.jpg" OnClientClick="setNonRecuring_Buffer(this); openDialogue(this,'gvNRBuffer','1','2','SubmitAPO'); return false;" />
                                                <br />
                                                <div class="GPSDetailScroll">
                                                    <cc:CustomGridView ID="gvGpsDetails" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered tablett"
                                                        Width="160PX" DataKeyNames="ActivityItemId" AllowPaging="false" PageSize="5"
                                        ...
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
                                                ...
                                                <cc:CustomImageButton ID="imgbtnDeleteNrBuffer" runat="server" OnClientClick="setNonRecuring_Buffer(); DeleteAPOSubItems(this,'gvNRBuffer','2','1','SubmitAPO'); return false;  "
                                                    ImageUrl="../Images/remove.png" />
                                            </ItemTemplate>
                                            <ItemStyle CssClass=" btnmobile" VerticalAlign="Middle" HorizontalAlign="Center" />
                                        </asp:TemplateField>
                                                        ...
                                                        <div style="display: block; position: relative; left: 15px; overflow: auto; width: 97%">
                                                            <cc:CustomGridView ID="ChildRecordsNonRecurringBuffer" runat="server" Width="100%" AutoGenerateColumns="false" DataKeyNames="ActivityItemId" ShowFooter="false"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Total" ItemStyle-Width="100px" ItemStyle-VerticalAlign="Top" ItemStyle-HorizontalAlign="Right">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lblTotalChild" runat="server" Text='<%#Eval("Total") %>' CssClass="less_size"></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    ...
                                                    <cc:CustomImageButton ID="imgbtnAddSubItemRCore" CssClass="btn btn-primary ButtonMargin"
                                                        runat="server" OnClientClick="return AddAPOSubItem(this,'gvRCore','1','2','SubmitAPO')" ImageUrl="../Images/plus.png" />
                                                    <cc:CustomImageButton ID="imgbtnDeleteRcore" runat="server" OnClientClick="setRecuring_core(); DeleteAPOSubItems(this,'gvRCore','1','2','SubmitAPO'); return false;  "
                                                        ImageUrl="../Images/remove.png" />
                                                </ItemTemplate>
                                                <ItemStyle CssClass=" btnmobile" VerticalAlign="Middle" HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    ...
                                                    <cc:CustomImageButton ID="imgbtnDeleteRbuffer" runat="server" OnClientClick="setRecuring_Buffer(); DeleteAPOSubItems(this,'gvRBuffer','2','2','SubmitAPO'); return false;"
                                                        ImageUrl="../Images/remove.png" />
                                                </ItemTemplate>
                                                <ItemStyle CssClass=" btnmobile" VerticalAlign="Middle" HorizontalAlign="Center" />
                                            </asp:TemplateField>
