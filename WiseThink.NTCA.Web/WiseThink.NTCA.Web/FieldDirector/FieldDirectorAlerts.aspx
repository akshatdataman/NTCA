<%@ Page Title="" Language="C#" MasterPageFile="~/FieldDirector/FieldDirector.Master"
    AutoEventWireup="true" CodeBehind="FieldDirectorAlerts.aspx.cs" Inherits="WiseThink.NTCA.Web.FieldDirector.FieldDirectorAlerts" %>
        ...
        <div class="row minheight">
            ...
            <div class="col-sm-offset-2 table-responsive TopMargin ">
                <cc:CustomGridView ID="cgvAlerts" runat="server" CssClass="table  col-sm-9" AutoGenerateColumns="False"
                    DataKeyNames="ID" AllowPaging="True" PageSize="5" OnPageIndexChanging="cgvAlerts_PageIndexChanging">
