<%@ Page Title="" Language="C#" MasterPageFile="~/FieldDirector/FieldDirector.Master" AutoEventWireup="true" CodeBehind="ViewTigerReserveDetails.aspx.cs" Inherits="WiseThink.NTCA.Web.FieldDirector.ViewTigerReserveDetails" %>
...
<div class="row minheight">
        ...
        <div class="col-sm-12 marginButton">
            <button id="Button1" type="button" onclick="window.location.href = 'FieldDirectorHome.aspx'" class="btn btn-primary col-sm-offset-5">
                Back</button>
        </div>
    </div>
</asp:Content>
