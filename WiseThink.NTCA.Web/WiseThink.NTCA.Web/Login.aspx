...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript">
        ...
        window.history.pushState('', null, './Login.aspx');
        ...
        <div class="col-sm-offset-3 col-sm-6 well MarginTop">
            ...
            <div class="form-group row bakcolor">
                ...
                <div class="col-sm-7">
                    ...
                    <asp:RequiredFieldValidator ID="UsernameRequired" runat="server" ControlToValidate="txtUserName"
                        ForeColor="#FF3300" ValidationGroup="LoginUserValidationGroup" ErrorMessage="User Name is required." SetFocusOnError="True"></asp:RequiredFieldValidator>
            ...
            <div class="form-group text-center row bakcolor">
                ...
                <div class="col-sm-offset-4 col-sm-6">
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidatorCaptch" runat="server" ControlToValidate="txtCaptcha" ForeColor="#FF3300" ValidationGroup="LoginUserValidationGroup" ErrorMessage="Captcha code as shown in Image is required." Display="Dynamic" SetFocusOnError="True">
