<%@ Page Title="" Language="C#" MasterPageFile="~/FieldDirector/FieldDirector.Master"
    AutoEventWireup="true" CodeBehind="AdditionalAPO.aspx.cs" Inherits="WiseThink.NTCA.Web.FieldDirector.AdditionalAPO" %>
                            ...
                            <div id="core1" class="tab-pane fade">
                                            ...
                                            <asp:TemplateField ControlStyle-Width="200px">
                                                <ItemTemplate>
                                                    ...
                                                    <cc:CustomImageButton ID="updateSomething" runat="server" CssClass="text-center"
                                                        Style="width: 50px; height: 25px;" ImageUrl="../Images/gps1.jpg" OnClientClick="setNonRecuring_Core(this); openDialogue(this,'gvNRCore','1','1','AdditionalAPO'); return false;" /><br />
                                ...
                                Text="Add More" CommandName="AddMoreItem" />--%>
                                                    ...
                                                    <cc:CustomImageButton ID="imgbtnAddSubItemNrCore" CssClass="btn btn-primary ButtonMargin"
                                                        runat="server" OnClientClick="return AddAPOSubItem(this,'gvNRCore','1','1','AdditionalAPO')" ImageUrl="../Images/plus.png" />
                                                    <cc:CustomImageButton ID="imgbtnDeleteNrCore" runat="server" OnClientClick="DeleteAPOSubItems(this,'gvNRCore','1','1','AdditionalAPO'); return false;"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ControlStyle-Width="200px">
                                                <ItemTemplate>
                                                    <cc:CustomLabel ID="lblGpsNote" runat="server" CssClass="less_size text-left" Text="Click icon to add GPS"></cc:CustomLabel>
                                                    <cc:CustomImageButton ID="updateSomething" runat="server" CssClass="text-center"
                                                        Style="width: 50px; height: 25px;" ImageUrl="../Images/gps1.jpg" OnClientClick="setNonRecuring_Buffer(this); openDialogue(this,'gvNRBuffer','2','1','AdditionalAPO'); return false;" />
                                                    <br />
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    ...
                                                    <cc:CustomImageButton ID="imgbtnAddSubItemNrBuffer" CssClass="btn btn-primary ButtonMargin"
                                                        runat="server" OnClientClick="return AddAPOSubItem(this,'gvNRBuffer','2','1','AdditionalAPO')" ImageUrl="../Images/plus.png" />
                                                    <cc:CustomImageButton ID="imgbtnDeleteNrBuffer" runat="server" OnClientClick="DeleteAPOSubItems(this,'gvNRBuffer','2','1','AdditionalAPO'); return false;  "
                                                        ImageUrl="../Images/remove.png" />
                                                </ItemTemplate>
                                                <ItemStyle CssClass=" btnmobile" VerticalAlign="Middle" HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ControlStyle-Width="200px">
                                                <ItemTemplate>
                                                    ...
                                                    <cc:CustomImageButton ID="updateSomething" runat="server" CssClass="text-center"
                                                        ...
                                                        OnClientClick="setRecuring_core(this); openDialogue(this,'gvRCore','2','1','AdditionalAPO'); return false;" />
                                                    <br />
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    ...
                                                    <cc:CustomImageButton ID="imgbtnAddSubItemRCore" CssClass="btn btn-primary ButtonMargin"
                                                        runat="server" OnClientClick="return AddAPOSubItem(this,'gvRCore','2','1','AdditionalAPO')" ImageUrl="../Images/plus.png" />
                                                    <cc:CustomImageButton ID="imgbtnDeleteRcore" runat="server" OnClientClick="DeleteAPOSubItems(this,'gvRCore','2','1','AdditionalAPO'); return false;  "
                                                        ImageUrl="../Images/remove.png" />
                                                </ItemTemplate>
                                                <ItemStyle CssClass=" btnmobile" VerticalAlign="Middle" HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField ControlStyle-Width="200px">
                                                <ItemTemplate>
                                                    ...
                                                    <cc:CustomImageButton ID="updateSomething" runat="server" CssClass="text-center"
                                                        Style="width: 50px; height: 25px;" ImageUrl="../Images/gps1.jpg"
                                                        OnClientClick="setRecuring_Buffer(this); openDialogue(this,'gvRBuffer','2','2','AdditionalAPO'); return false;" /><br />
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    ...
                                                    <cc:CustomImageButton ID="imgbtnAddSubItemRbuffer" CssClass="btn btn-primary ButtonMargin"
                                                        runat="server" OnClientClick="return AddAPOSubItem(this,'gvRBuffer','2','2','AdditionalAPO')" ImageUrl="../Images/plus.png" />
                                                    <cc:CustomImageButton ID="imgbtnDeleteRbuffer" runat="server" OnClientClick="DeleteAPOSubItems(this,'gvRBuffer','2','2','AdditionalAPO'); return false;"
                                                        ImageUrl="../Images/remove.png" />
                                                </ItemTemplate>
                                                <ItemStyle CssClass=" btnmobile" VerticalAlign="Middle" HorizontalAlign="Center" />
                                            </asp:TemplateField>
