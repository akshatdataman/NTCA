<%@ Page Title="" Language="C#" MasterPageFile="~/CWW-Secretary/CWW-Secretary.master"
    AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ViewQuarterlyReport.aspx.cs" Inherits="WiseThink.NTCA.Web.CWW_Secretary.ViewQuarterlyReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CWWPlaceHolder" runat="server">
    <div class="row minheight">
        <div class="row">
            <h4 id="SubmitApoHeader" runat="server">
                ...
                <cc:CustomImageButton ID="imgbtnWord" runat="server" ImageUrl="~/Images/Word-icon.png"
                    OnClick="imgbtnWord_click" CssClass="col-sm-offset-6" OnClientClick="RemoveBlockUi()" />
                <cc:CustomImageButton ID="imgbtnPdf" runat="server" ImageUrl="~/Images/samplePDFIcon.png"
                    OnClick="imgbtnPdf_click" CssClass="" OnClientClick="RemoveBlockUi()" />
                <cc:CustomImageButton ID="imgbtnExcel" runat="server" ImageUrl="~/Images/sampleExcelIcon.jpg"
                    OnClick="imgbtnExcel_click" CssClass="" OnClientClick="RemoveBlockUi()" />
            </h4>
        </div>

         <div class="row">
            <div class="col-sm-4">
                <cc:CustomLabel ID="lblReortTypeTitle" runat="server" Text="Select Report Type *:"></cc:CustomLabel>
            </div>
            <div class="col-sm-6">
                <cc:CustomDropDownList ID="ddlReportType" runat="server" req="1" Height="30px" class="form-control col-sm-8"
     ...
     <%--   <div class="row">
            <div class="col-sm-4">
                <cc:CustomLabel ID="lblApoTitle" runat="server" Text="Select Apo Title:"><b class="REerror"> *</b></cc:CustomLabel>
            </div>
            <div class="col-sm-6">
                ...
                <div class="tablettcolor">
                    <cc:CustomGridView ID="gvNonRecurring" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Label ID="lblState" runat="server" CssClass="less_size" Text=""></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Label ID="lblTotal" runat="server" CssClass="less_size" Text=""></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </cc:CustomGridView>
