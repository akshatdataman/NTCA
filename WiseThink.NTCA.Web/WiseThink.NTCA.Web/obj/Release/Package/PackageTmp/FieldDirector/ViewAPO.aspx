<%@ Page Title="" Language="C#" MasterPageFile="~/FieldDirector/FieldDirector.Master"
    AutoEventWireup="true" CodeBehind="ViewAPO.aspx.cs" Inherits="WiseThink.NTCA.Web.FieldDirector.ViewAPO" %>
        ...
        <div class="col-sm-12 minHeight" id="MainContent" runat="server">
            ...
            <div id="Non-RecurringDiv">
                ...
                <div style="overflow: auto">
                    <cc:CustomGridView ID="gvNonRecurring" runat="server" AutoGenerateColumns="false"
                        OnRowCreated="gvNonRecurring_RowCreated" ShowHeader="false" CssClass="table table-bordered table-responsive tablett"
                        AllowPaging="false" PageSize="10" ShowFooter="true" OnRowDataBound="gvNonRecurring_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Para No. CSS PT Guidelines" ControlStyle-Width="60px">
                                <ItemTemplate>
                                    <asp:Label ID="lblCssPT" runat="server" Text='<%#Eval("ParaNoCSSPTGuidelines") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Para No. TCP" ControlStyle-Width="40px">
                                <ItemTemplate>
                                    <asp:Label ID="lblParaNoTCP" runat="server" Text='<%#Eval("ParaNoTCP") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Amount released PFY" ItemStyle-Width="40px" >
                                <ItemTemplate>
                                    <asp:Label ID="lblPFYAmount" runat="server" Text='<%#Eval("PFYTotal") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="No. of Items (Physical Target)" ControlStyle-Width="50px">
                                <ItemTemplate>
                                    <asp:Label ID="lblNumberOfItems" runat="server" Text='<%#Eval("NumberOfItems") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Sub-item Details" ControlStyle-Width="200px">
                                <ItemTemplate>
                                    <div id="SubItemDetailsdiv" runat="server">
                                        <ul id="SubItemDetailsUl" style="-webkit-padding-start: 8px;" runat="server">
                                        </ul>
                                    </div>
                            ...
                            <asp:TemplateField HeaderText="Unit Price" ControlStyle-Width="60px">
                                <ItemTemplate>
                                    <asp:Label ID="lblUnitPrice" runat="server" Text='<%#Eval("UnitPrice") %>' Visible="false"></asp:Label>
                                    <div id="UnitPricediv" runat="server">
                                        <ul id="UnitPriceUl" style="-webkit-padding-start: 8px;" runat="server">
                                        </ul>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Total (Financial Target)" ControlStyle-Width="60px">
                                <ItemTemplate>
                                    <asp:Label ID="lblTotal" runat="server" Text='<%#Eval("Total") %>'></asp:Label>
                                </ItemTemplate>
                                <FooterTemplate>
                                    <asp:Label ID="txtNRSubTotal" runat="server" Text='<%#Eval("NRTotal") %>'></asp:Label>
                                </FooterTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="GPS" ControlStyle-Width="130px">
                                <ItemTemplate>
                                    ...
                                    <div id="GpsDetailsdiv" runat="server">
                                        <ul id="GpsDetailsUl" style="-webkit-padding-start: 8px;" runat="server">
                                        </ul>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>
                             <asp:TemplateField HeaderText="Justification" ControlStyle-Width="150px">
                                    <ItemTemplate>
                                    <div id="JustificationDetailsDiv" runat="server">
                                        <ul id="JustificationDetailsUl" style="-webkit-padding-start: 8px;" runat="server">
                                        </ul>
                                    </div>
            ...
            <div id="RecuringDiv" runat="server">
                <div>
                    ...
                    <!--Here is Recuring-->
                    <div style="overflow: auto">
                        <cc:CustomGridView ID="gvRecuring" runat="server" AutoGenerateColumns="false" AllowPaging="false"
                            PageSize="10" CssClass="table table-bordered table-responsive tablett" OnRowCreated="gvRecuring_RowCreated"
                            ShowHeader="false" ShowFooter="true" OnRowDataBound="gvRecuring_RowDataBound">
                            <PagerSettings FirstPageText="First Page" LastPageText="Last Page" PageButtonCount="4"
                                Mode="NextPreviousFirstLast" NextPageText="Next Page" PreviousPageText="Previous Page" />
                            <PagerStyle HorizontalAlign="Center" CssClass="pagination-ys" />
                            <EmptyDataTemplate>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Total (Financial Target)">
                                    ...
                                    <FooterTemplate>
                                        <asp:Label ID="txtRSubTotal" runat="server" Text='<%#Eval("RTotal") %>'></asp:Label>
                                    </FooterTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="GPS" ControlStyle-Width="130px">
                                    <ItemTemplate>
                        ...
                        <div>
                            ...
                            <div style="overflow: auto">
                                <cc:CustomGridView ID="gvApoAmountBreakup" runat="server" AutoGenerateColumns="false" AllowPaging="false"
                                    ...
                                    ShowHeader="false" ShowFooter="true" Width="100%" OnRowDataBound="gvApoAmountBreakup_RowDataBound">
                                    <PagerSettings FirstPageText="First Page" LastPageText="Last Page" PageButtonCount="4"
                                        Mode="NextPreviousFirstLast" NextPageText="Next Page" PreviousPageText="Previous Page" />
                                    <PagerStyle HorizontalAlign="Center" CssClass="pagination-ys" />
                                    <EmptyDataTemplate>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="" FooterStyle-BackColor="lightgray">
                                            <ItemTemplate>
                                             ...
                                             <FooterTemplate>
                                                      <b>  <asp:Label ID="lblSr" runat="server" Text='<%#Eval("Sr") %>' ></asp:Label> </b>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Central Share(50)" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" FooterStyle-VerticalAlign="Middle" FooterStyle-BackColor="lightgray">
                                            ...
                                            <FooterTemplate>
                                                      <b>  <asp:Label ID="lblRCentral" runat="server" Text='<%#Eval("RCentral") %>'></asp:Label> </b>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="State Share(50)" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" FooterStyle-VerticalAlign="Middle" FooterStyle-BackColor="lightgray">
                                            <ItemTemplate>
                                                <asp:Label ID="lblStateShareCore" runat="server" Text='<%#Eval("RStateShare")%>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                      <b>  <asp:Label ID="lblRState" runat="server" Text='<%#Eval("RState") %>'></asp:Label> </b>
                                            </FooterTemplate>
                                            <ItemStyle />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Central Share (60)" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" FooterStyle-VerticalAlign="Middle" FooterStyle-BackColor="lightgray">
                                            ...
                                            <FooterTemplate>
                                                      <b>  <asp:Label ID="lblNRCentral" runat="server" Text='<%#Eval("NRCentral") %>'></asp:Label> </b>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="State Share(40)" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" FooterStyle-VerticalAlign="Middle" FooterStyle-BackColor="lightgray" >
                                            ...
                                            <FooterTemplate>
                                                      <b>  <asp:Label ID="lblNRState" runat="server" Text='<%#Eval("NRState") %>'></asp:Label> </b>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" FooterStyle-VerticalAlign="Middle" FooterStyle-BackColor="lightgray" >
                                            ...
                                            <FooterTemplate >
                                                      <b>  <asp:Label ID="lblGrandTotal1" runat="server" Text='<%#Eval("GTotal") %>'></asp:Label> </b>
                                            </FooterTemplate>
            ...
            <div id="GrandTotal" runat="server" class="form-group row">
                ...
                <b>
                    ...
                    <b>  <cc:CustomLabel CssClass="text-right" ID="lblRorNRAmount" runat="server"></cc:CustomLabel>
                    
                        <cc:CustomLabel CssClass="text-right" ID="lblGrandTotal" runat="server"></cc:CustomLabel></b>
