<%@ Page Title="" Language="C#" MasterPageFile="~/NTCA-RO/NTCA-RO.master" AutoEventWireup="true"
    CodeBehind="ViewAPO.aspx.cs" Inherits="WiseThink.NTCA.Web.NTCA_RO.ViewAPO" %>
            ...
            <ContentTemplate>
                <div class="col-sm-12 minHeight" id="MainContent" runat="server">
                    ...
                    <div id="GrandTotal" runat="server" class="form-group row">
                        <b>
                            <label for="GrandTotalLabel" class="col-sm-3 control-label" style="width:18%">
                                Total (Non-Recurring + Recurring):</label></b>
                        <div class="col-sm-4 ">
                          
                                <cc:CustomLabel CssClass="text-right" ID="lblRorNRAmount" runat="server"></cc:CustomLabel></b>
                              <b>    <cc:CustomLabel CssClass="text-right"  ID="lblGrandTotal" runat="server"></cc:CustomLabel></b>
                        </div>
                    </div>
                </div>
            </ContentTemplate>
