<%@ Page Title="" Language="C#" MasterPageFile="~/NTCA-RO/NTCA-RO.master" AutoEventWireup="true"
    CodeBehind="FDFeedback.aspx.cs" Inherits="WiseThink.NTCA.Web.NTCA_RO.FDFeedback" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script type="text/javascript" language="javascript">
    $(document).ready(function () {
        var prm = Sys.WebForms.PageRequestManager.getInstance();
        $('#<%=gvFeebbackFD.ClientID %>').Scrollable({
            ScrollHeight: 500
        });
        if (prm != null) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="NTCAPlaceHolder" runat="server">
    <div>
        <div class="row minheight">
            <h4>
                <b>Feedback of Field Director</b></h4>
            <%--<div class="col-sm-3">
                                    ...
                                    <div class="table-responsive">
                                        <ul>
                                            ...
                                            <li class="BackgroundColor "><a href="ViewCWWObligations.aspx">View Obligations - CWW
                                                / SF</a></li>
                                            <li class="BackgroundColor Current"><a href="FDFeedback.aspx">Feedback - FD </a>
                                            </li>
                                            <li class="BackgroundColor "><a href="FDFeedback.aspx">Feedback - CWW / SF </a></li>
                ...
                <div class=" table-responsive TopMargin ">
                    <asp:UpdatePanel ID="upnlObligation" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <cc:CustomGridView ID="gvFeebbackFD" runat="server" CssClass="table  col-sm-12" AutoGenerateColumns="False"
                                DataKeyNames="ObligationId" AllowPaging="False" PageSize="5">
