<%@ Page Title="" Language="C#" MasterPageFile="~/FieldDirector/FieldDirector.Master"
    AutoEventWireup="true" CodeBehind="ViewUtilizationCertificate.aspx.cs" Inherits="WiseThink.NTCA.Web.FieldDirector.ViewUtilizationCertificate"
...
<asp:Content ID="Content2" ContentPlaceHolderID="FieldDirectorPlaceHolder" runat="server">
    <div id="ucDiv" runat="server" class="row minheight">
        <div class="row">
            ...
            <cc:CustomImageButton ID="imgbtnWord" runat="server" Visible="false" ImageUrl="~/Images/Word-icon.png"
            ...
            <div class="col-sm-12 ">
                ...
                <div class="col-sm-12 text-center">
                    <cc:CustomButton ID="btnAddNew" CssClass="btn-primary btn col-sm-offset-0" runat="server"
                        PostBackUrl="FDUtilizationCertificate.aspx" Text="Back" />
                </div>
            </div>
        </div>
