<%@ Page Title="" Language="C#" MasterPageFile="~/FieldDirector/FieldDirector.Master"
    AutoEventWireup="true" CodeBehind="SendAlert.aspx.cs" Inherits="WiseThink.NTCA.Web.FieldDirector.SendAlert" %>
    ...
    <div class="row">
        ...
        <div class="sendAlertMinheigt" id="divSendNotification">
            ...
            <div class="form-group col-sm-12">
                ...
                <div class="col-sm-8">
                    <cc:CustomTextBox ID="txtComments" TextMode="MultiLine" Rows="4" Columns="50" runat="server" req="1"
                        class="form-control" placeHolder="Comments"></cc:CustomTextBox>
                </div>
            </div>
            <div class="col-sm-offset-4 col-sm-2 marginButton">
                <cc:CustomButton ID="btnSend" runat="server" Text="Send" CssClass="btn btn-primary" OnClientClick = "return Validate()"
            ...
            <div class="col-sm-2 marginButton bottomMargin">
                ...
                <button id="Button1" type="button" onclick="window.location.href = 'FieldDirectorAlerts.aspx'"
