    ...
    public partial class ViewUtilizationCertificate : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["APOFileId"] != null)
            {
                ...
                DataSet dsTigerReserveId = APOBAL.Instance.GetStateIdTigerReserveIdAndFinancialYear(apoFileId);
                ...
                if (ds.Tables[2].Rows.Count > 0)
                {
                    ...
                    lbtnFileName.Text = dr["FinnalUcFileName"].ToString();
                }
        ...
        protected void lbtnFileName_Click(object sender, EventArgs e)
        {
            ...
            if (lbtnFileName.Text != string.Empty)
            {
                ...
                ScriptManager.RegisterClientScriptBlock(this.Page, this.Page.GetType(), "script", "LoadUCPage()", false);
                response.End();
            }
        }
