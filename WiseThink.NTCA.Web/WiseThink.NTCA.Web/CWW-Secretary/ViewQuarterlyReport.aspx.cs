...
namespace WiseThink.NTCA.Web.CWW_Secretary
{
    public partial class ViewQuarterlyReport : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //if (ddlApoTitle.SelectedValue != "0" && ddlApoTitle.SelectedValue != "" && ddlApoTitle.SelectedValue != "Select APO Title")
            //{
        ...
        protected void ddlApoTitle_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //{
            //    int apoId = Convert.ToInt32(ddlApoTitle.SelectedValue);
            //    GetQuarterlyReportFormat();
            //}
            if (ddlApoTitle.SelectedIndex != 0)
            {
        ...
        private void GetCurrentYearApprovedApoTitle()
        {
            ...
            //if (ddlApoTitle.Items.Count > 1)
            //{
            //    MainContent.Visible = true;
            //    ddlNRQuarter.Visible = true;
            //    lblNRQuarter.Visible = true;
            //}
            //else
            //{
            //    MainContent.Visible = false;
            //    ddlNRQuarter.Visible = false;
            //    lblNRQuarter.Visible = false;
            //}
        }
        ...
        {
            //int selectedValue=Convert.ToInt32(ddlNRQuarter.SelectedValue);
            //int periodId=selectedValue-1;
            DataSet dsReport = new DataSet();
            //if (IsEdit == true)
            //    dsReport = APOBAL.Instance.GetApoForModification(Convert.ToInt32(oApo.TigerReserveId));
            //else
            //dsReport = QuarterlyReportBAL.Instance.GetQuarterlyReportFormatForCWwAndNTCAQuartely(oApo.TigerReserveId,periodId);
