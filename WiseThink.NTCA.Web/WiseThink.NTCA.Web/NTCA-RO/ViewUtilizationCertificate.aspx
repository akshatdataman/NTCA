<%@ Page Title="" Language="C#" MasterPageFile="~/NTCA-RO/NTCA-RO.master" AutoEventWireup="true"
    CodeBehind="ViewUtilizationCertificate.aspx.cs" Inherits="WiseThink.NTCA.Web.NTCA_RO.ViewUtilizatinCertificate"
    ...
    <div id="ucDiv" runat="server" class="row minheight">
          ...
          <div class="row TopMargin">
                ...
                <label class="col-sm-3">
                    ...
                    <cc:CustomButton ID="btnUploadFinalUc" runat="server" Text="Upload" CssClass="btn btn-primary"
                     OnClientClick="return confirm('Are you sure? you want to upload previous financial year UC and move to step 4!!');" OnClick="btnUploadFinalUc_Click" />
                </div>
                </div>
                </div>
        ...
        <div class="col-sm-12 ">
            ...
            <span>Kinds of checks exercised:<br />
                ...
                3. The Monitoring and Evaluation Wings of the Department headed by CCF rank and the
                P & D Department of the Govt. of Assam also conduct random physical checking of
                the works in the field.<br />
