<%@ Page Title="" Language="C#" MasterPageFile="~/NTCA-RO/NTCA-RO.master" AutoEventWireup="true"
    CodeBehind="EditApo.aspx.cs" Inherits="WiseThink.NTCA.Web.NTCA_RO.EditApo" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="" onclick="closeGPSpopup(this)" data-dismiss="modal">
                                &times;</button>
                            ...
                            <div id="panel1" class="panel-collapse collapse in menuleft">
                                <div class="table-responsive">
                                    <ul>
                                        ...
                                        <li class="BackgroundColor "><a href="ViewCWWObligations.aspx">View CWLW's Obligations
                                        </a></li>--%>
