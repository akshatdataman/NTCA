<%@ Page Title="" Language="C#" MasterPageFile="~/NTCA-RO/NTCA-RO.master" AutoEventWireup="true"
    CodeBehind="MonitoringCentral-StateShare.aspx.cs" Inherits="WiseThink.NTCA.Web.NTCA_RO.MonitoringCentral_StateShare" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="NTCAPlaceHolder" runat="server">
    <div class="row minheight">
        <h4>
            <b>Monitoring Central : State Share and Releasing Central Share</b></h4>
        ...
        <div id="IFDdiv" runat="server" class="col-sm-12 form-group">
            <div class="col-sm-4">
                <cc:CustomLabel ID="lblIfdDiaryNumber" runat="server" Text="IFD Diary Number:"><b class="REerror"> *</b></cc:CustomLabel>
            </div>
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                <cc:CustomLabel ID="lblIfdDate" runat="server" Text="IFD Date:"><b class="REerror"> *</b></cc:CustomLabel>
            </div>
            <div class="col-sm-3">
        ...
        <div id="FistInstallmentDiv" runat="server" class="col-sm-12 form-group">
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <cc:CustomButton ID="btnFirstRelease" runat="server" Text="Click here to release first installment" CssClass="btn-primary btn" 
                OnClientClick="return confirm('Are you sure? you want to release first installment of this apo!');" OnClick="btnFirstRelease_Click" />
            </div>
        </div>
        <div id="SecondInstallmentDiv" runat="server" class="col-sm-12 form-group">
            <div class="col-sm-4">
            ...
            <div class="col-sm-4">
                <cc:CustomButton ID="btnSecondRelease" runat="server" Text="Click here to release second installment" CssClass="btn-primary btn" 
                OnClientClick="return confirm('Are you sure? you want to release second installment of this apo!');" OnClick="btnSecondRelease_Click" />
            </div>
        </div>
        <div class="col-sm-12 table-responsive form-group">
            <cc:CustomGridView ID="cgvCentralStateShare" runat="server" CssClass="table  col-sm-12"
                AllowPaging="true" PageSize="5" AutoGenerateColumns="False" DataKeyNames="APOFileId"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="First Released Amount Rs. (In Lakhs)">
                        <ItemTemplate>
                            <asp:Label ID="lblFirstReleasedAmount" runat="server" Text='<%#Eval("FirstCentralRelease") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <cc:CustomTextBox ID="txtFirstReleasedAmount" runat="server" CssClass="form-control" Text='<%#Eval("FirstCentralRelease") %>'></cc:CustomTextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="324px" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Second Released Amount Rs. (In Lakhs)">
                        <ItemTemplate>
                            <asp:Label ID="lblSecondReleasedAmount" runat="server" Text='<%#Eval("SecondCentralRelease") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <cc:CustomTextBox ID="txtSecondReleasedAmount" runat="server" CssClass="form-control"
                                Text='<%#Eval("SecondCentralRelease") %>'></cc:CustomTextBox>
                        </EditItemTemplate>
                        <ItemStyle Width="324px" />
                    </asp:TemplateField>
